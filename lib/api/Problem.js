...
// const randomInt = new RandomInteger({
//   range: [0, 100],
//   constraints: []
// });
...
//     );
//   },
//   operands: [randomInt, randomInt]
// });

// const subtractionProblem = new Problem({
//   operator: operands => {
//     return algebrite.quote(
//       `(${operands[0]}) - (${operands[1]})`
//     );
...
// const divisionProblem = new Problem({
//   operator: operands => {
//     return math.parse(
//       `(${operands[0]}) / (${operands[1]})`
//     ).toString({ parenthesis: 'none' });
//   },
//   operands: [
//     randomInt,
//     new RandomInteger({
...
//       target: 1,
//       constraints: [
//         modifier => target => modifier % target === 0,
//         modifier => target => target < modifier / 2
//       ]
//     }
//   ]
// });
...
// console.log(
//   divisionProblem.getProblem().toString()
// );
